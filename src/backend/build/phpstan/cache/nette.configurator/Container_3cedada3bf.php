...
class Container_3cedada3bf extends _PHPStan_7dc4cc62e\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_3cedada3bf $container)
			{
	...
	public function createServiceContainer(): Container_3cedada3bf
	{
		return $this;
	}
