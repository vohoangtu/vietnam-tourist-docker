...
class Container_84dee7e2fe extends _PHPStan_7dc4cc62e\Nette\DI\Container
{
	protected $tags = [
		...
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			...
			[
				...
				[
					...
					'paths' => ['c:\Users\PC\Documents\Vietnamtourist\Working\Docker\src\backend\tests\*'],
				],
			],
			true
		);
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_84dee7e2fe $container)
			{
	...
	public function createServiceContainer(): Container_84dee7e2fe
	{
		return $this;
	}
