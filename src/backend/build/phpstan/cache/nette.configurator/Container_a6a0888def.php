...
class Container_a6a0888def extends _PHPStan_7dc4cc62e\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService051(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			$this->getService('081'),
			[['identifier' => 'missingType.iterableValue'], ['identifier' => 'missingType.generics'], '#PHPDoc tag @var#'],
			true
		);
	}
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_a6a0888def $container)
			{
	...
	public function createServiceContainer(): Container_a6a0888def
	{
		return $this;
	}
