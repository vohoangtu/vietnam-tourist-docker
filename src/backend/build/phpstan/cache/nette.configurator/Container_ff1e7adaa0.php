...
class Container_ff1e7adaa0 extends _PHPStan_7dc4cc62e\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_ff1e7adaa0 $container)
			{
	...
	public function createServiceContainer(): Container_ff1e7adaa0
	{
		return $this;
	}
